"use strict";
(self["webpackChunkannotation"] = self["webpackChunkannotation"] || []).push([["vendors-node_modules_web3auth_openlogin-adapter_dist_openloginAdapter_esm_js"],{
...
class OpenloginAdapter extends _web3auth_base__WEBPACK_IMPORTED_MODULE_1__.BaseAdapter {
  constructor(params) {
    ...
    if ((_params$chainConfig3 = params.chainConfig) !== null && _params$chainConfig3 !== void 0 && _params$chainConfig3.chainNamespace) {
      ...
      if (!this.chainConfig.rpcTarget && params.chainConfig.chainNamespace !== _web3auth_base__WEBPACK_IMPORTED_MODULE_1__.CHAIN_NAMESPACES.OTHER) {
  ...
  async authenticateUser() {
    if (this.status !== _web3auth_base__WEBPACK_IMPORTED_MODULE_1__.ADAPTER_STATUS.CONNECTED) throw _web3auth_base__WEBPACK_IMPORTED_MODULE_1__.WalletLoginError.notConnectedError("Not connected with wallet, Please login/connect first");
  ...
  async connectWithProvider(params) {
    ...
    if (this.currentChainNamespace === _web3auth_base__WEBPACK_IMPORTED_MODULE_1__.CHAIN_NAMESPACES.SOLANA) {
      ...
      } = await Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_tweetnacl_nacl-fast_js"), __webpack_require__.e("vendors-node_modules_web3auth_ethereum-provider_dist_ethereumProvider_esm_js"), __webpack_require__.e("_dba7")]).then(__webpack_require__.bind(__webpack_require__, /*! @web3auth/ethereum-provider */ "./node_modules/@web3auth/ethereum-provider/dist/ethereumProvider.esm.js"));
...
//# sourceMappingURL=vendors-node_modules_web3auth_openlogin-adapter_dist_openloginAdapter_esm_js.index.js.map