(self["webpackChunkannotation"] = self["webpackChunkannotation"] || []).push([["vendors-node_modules_web3auth_torus-solana-adapter_dist_torusSolanaAdapter_esm_js"],{
...
/* harmony import */ var _web3auth_base_solana_adapter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @web3auth/base-solana-adapter */ "./node_modules/@web3auth/base-solana-adapter/dist/baseSolanaAdapter.esm.js");
/* harmony import */ var _web3auth_solana_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @web3auth/solana-provider */ "./node_modules/@web3auth/solana-provider/dist/solanaProvider.esm.js");
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
class SolanaWalletAdapter extends _web3auth_base_solana_adapter__WEBPACK_IMPORTED_MODULE_3__.BaseSolanaAdapter {
  constructor() {
    let params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    super();
  ...
  async init(options) {
    ...
    this.solanaProvider = new _web3auth_solana_provider__WEBPACK_IMPORTED_MODULE_4__.TorusInjectedProvider({
      config: {
...
//# sourceMappingURL=vendors-node_modules_web3auth_torus-solana-adapter_dist_torusSolanaAdapter_esm_js.index.js.map