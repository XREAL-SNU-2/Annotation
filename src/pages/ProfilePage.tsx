...
function ProfilePage() {
  ...
  React.useEffect(() => {
    ...
    const getBoughtNotes = async () => {
      ...
      const _boughtNotes = await queryOfNote.equalTo(
        'buyers',
        user?.get('username'),
      );
                ...
                >
                  <div className="informationContainer" key={index}>
                    ...
                    <div className="informationDetail">
                      {boughtNote.get('noteDetail').substring(0, 100) + '...'}
                    </div>
                  </div>
                </Link>
              </>
              ...
              <>
                ...
                >
                  <div className="informationContainer" key={index}>
                    ...
                    <div className="informationDetail">
                      {writtenNote.get('noteDetail').substring(0, 100) + '...'}
                    </div>
                  </div>
                </Link>
              </>
    ...
    return (
      <>
        ...
        <div className="tokenContainer">
          ...
          <div className="tokenCount">1354</div>
          <button
            className="buyToken"
            onClick={() => {
              alert('개발 예정입니다.');
    ...
    <>
      <div className="page profile">
        <div className="body">
              ...
              {[...Array(6)].map((key, index) => {
                return (
                  <>
                    <div className="badge">
                      <img
                        src={require(`../images/badges/Badge` +
                          (index + 1) +
                          `.png`)}
                        alt=""
                      />
          ...
          <div
            className="InformationContainer middleAlign"
            style={{ marginTop: '77px' }}
          >
            <div className="containerTitle">작성글 리스트</div>
            <div className="InformationList">
              <div className="InformationListScroll">{writtenNoteList}</div>
            </div>
          </div>
          <div className="InformationContainer middleAlign">
            ...
            <div className="InformationList pdf">
              <div className="InformationListScroll">{boughtPdfList}</div>
            </div>
          </div>
          <div className="InformationContainer middleAlign">
            <div className="containerTitle">구매글 리스트</div>
            <div className="InformationList">
              <div className="InformationListScroll">{boughtNoteList}</div>
            </div>
          </div>
        </div>
      </div>
